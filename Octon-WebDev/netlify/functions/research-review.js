...
exports.handler=async function(event){
  ...
  try{
    ...
    return jsonResponse(200,{ok:true,mode:"READ_ONLY",engine:"Octon Live Web Research v1.3",kind,portal:c,summary:p.summary||res.text.slice(0,1500),findings,sources:res.sources,coverage:p.coverage||[],limitations:p.limitations||[],generatedAt:new Date().toISOString()});
