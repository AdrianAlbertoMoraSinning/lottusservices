...
exports.handler=async function(event){
  ...
  return jsonResponse(200,{ok:results.some(x=>x.ok),mode:"READ_ONLY",engine:"Octon PageSpeed Live Audit v1.3",target:u.toString(),results,generatedAt:new Date().toISOString()});
};
