...
$('#payDemo')?.addEventListener('click',()=>{alert('Demo de pago: aquí se conecta Wompi / PayU / Mercado Pago / Stripe / Nequi. El carrito ya entrega total y productos seleccionados.')});
